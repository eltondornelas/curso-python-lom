...
class User(StringReprMixin):
    def __init__(self) -> None:
        # poderia utilizar parâmetros nomeados, mas fugiria do padrão Builder =
        # (self, firstname=None, age=None ...)
        self.firstname = None
        self.lastname = None
        self.age = None
...
class UserBuilder(IUserBuilder):
    ...
    def result(self) -> User:
        return_data = self._result  # Retorna o User()
        self.reset()
        return return_data
...
class UserDirector:
    ...
    # como os setters retornam self, pode fazer encadeamento de métodos
