...
class VeiculoFactory:
    def __init__(self, tipo) -> None:
        ...
        # ao instanciar ele já fica pronto pra retornar o tipo do veículo
        # ou seja, não retorna o objeto real, pode ser algo melhor olhando por esse lado
        # chamado de Wrapper, pois a factory envolve o objeto
