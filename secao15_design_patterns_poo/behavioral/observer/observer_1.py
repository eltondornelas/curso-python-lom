...
class WeatherStation(IObservable):
    """ Observable """
    """ Exemplo do Head First, utiliza uma Estação Climática"""
    ...
    def state(self, state_update: Dict) -> None:
        ...
        # desempacota o state atual e as atualizações, se tiver algo diferente
        # do atual, ele atualiza e notifica

        # só notifica se realmente tiver alguma modificação
