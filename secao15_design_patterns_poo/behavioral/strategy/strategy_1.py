...
*Intercambiável -> pode trocar de algoritmo quando quiser, trocando os
    descontos, customizando-os.

** Pedidos serão essas entidades no exemplo e desconto a estratégia
"""
...
class Order:
    ...
    def total_with_discount(self):
        ...
        # o desconto é que vai controlar
...
# Cria uma classe ao invés de criar uma condição para sem desconto
