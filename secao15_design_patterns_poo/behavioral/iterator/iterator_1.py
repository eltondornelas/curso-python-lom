...
* Aggregate -> lista, dicionario... é o iteravel, é o objeto com os dados
** for...

# A interface Aggregate do UML no Python já existe com o nome de Iterable
"""
...
class MyIterator(Iterator):
    # iterador só pode ser instanciado se possuir o __next__ no escopo
...
class MyList(Iterable):
    # o iterable só pode ser instanciado se possuir o __iter__ no escopo
