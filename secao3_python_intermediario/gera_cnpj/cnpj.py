...
def gera():
    ...
    inicio_cnpj = f'{primeiro_digito}{segundo_digito}{segundo_bloco}' \
                  f'{terceiro_bloco}{quarto_bloco}00'  # o 00 foi apenas para completar a quantidade dos números do cnpj
...
def formata(cnpj):
    cnpj = apenas_numeros(cnpj)  # garantindo que só tenha números
