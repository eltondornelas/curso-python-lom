...
class TestPessoa(unittest.TestCase):
    # setUp() sempre executa antes de cada teste
    def setUp(self):
    ...
    def test_obter_todos_os_dados_sucesso_OK(self):
        with patch('requests.get') as fake_request:
            # diz que o requests.get vai ser chamado e vai ter tal comportamento, é um mock e se assemelha ao expect no easymock do java
